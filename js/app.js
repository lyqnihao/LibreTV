// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy", "bfzy", "ruyi","zy360","wolong", "hwba","jisu","mdzy","zuid", "dbzy"]'); // 默认选中天涯资源、暴风资源和如意资源，添加360、卧龙、华为吧、极速、魔都、最大和豆瓣资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中天涯资源、暴风资源和如意资源，添加360、卧龙、华为吧、极速、魔都、最大和豆瓣资源
        selectedAPIs = ["tyyszy", "bfzy", "ruyi","zy360","wolong", "hwba","jisu","mdzy","zuid", "dbzy"];
